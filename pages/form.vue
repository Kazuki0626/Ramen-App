      ...
      <div class="contact-form_content">
        ...
        <div class="contact-form_text">
          ...
          <textarea
            ...
            placeholder="入力"
            required="required"
            class="contact-form_text_item"
          />
        </div>
        <div class="contact-form_btn">
          <nuxt-link to="../form-result/result/">
            <button type="button" class="contact-form_btn_click">送信</button>
          </nuxt-link>
        </div>
      </div>
    </div>
